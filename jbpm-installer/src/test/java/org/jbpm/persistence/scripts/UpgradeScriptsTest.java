...
public class UpgradeScriptsTest extends ScriptsBase{
    ...
    public void testExecutingScripts(String type) throws IOException, SQLException {
        logger.debug("entering testExecutingScripts with type: "+type);
        try {
    ...
    public void testPersistedProcess(String type) throws IOException, ParseException, SQLException {
        ...
        try {
            createSchema60UsingDDLs();
            persistOldProcessAndSessionAndCreateTask(type);
            signalEventOnPersistedSession();
        } finally {
            dropFinalSchemaAfterUpgradingUsingDDLs();
        }
    }
    ...
    private void persistOldProcessAndSessionAndCreateTask(String type) throws IOException, SQLException {
    ...
    private void signalEventOnPersistedSession() {
